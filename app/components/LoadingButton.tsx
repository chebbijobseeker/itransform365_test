...
const LoadingButton: React.FC<LoadingButtonProps> = ({
  ...
  return (
    <button
      type="submit"
      onClick={onClick}
      className="tw-bg-blue-500 tw-hover:bg-blue-600 tw-text-white tw-font-bold tw-py-3 tw-px-6 tw-rounded tw-relative"
    ...
    >
      ...
      {isLoading && (
        <span className="tw-absolute tw-inset-0 tw-flex tw-items-center tw-justify-center">
          <svg className="tw-animate-spin tw-h-5 tw-w-5" viewBox="0 0 24 24">
            <circle
